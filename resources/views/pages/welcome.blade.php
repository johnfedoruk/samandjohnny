...
-->
      <div class="jumbotron" style="color: white;background:url('https://media.timeout.com/images/100644443/image.jpg');background-size:cover;">
        <h1 style="color:lavender;">Welcome {{Auth::check()?Auth::user()->name:"to our blog!!"}}</h1>
